...
<div class="main-content mt-5">
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body ">
                <button>
                    <a class="btn btn-sm btn-secondary" href="{{ route('inventory.create') }}">Tambah Produk</a>
                </button>
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-secondary text-white">{{ $product->toppings()->pluck('name')->implode(', ') }}</span></td>
                            <td>
