...
<div class="main-content mt-5">
    <div class="container-fluid">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-value">{{ $countOrder ?? 0 }}</div>
                <div class="stat-label">Total Orders</div>
            </div>
            <div class="stat-card">
                <div class="stat-value">{{ $countProduct ?? 0 }}</div>
                <div class="stat-label">Total Products</div>
            </div>
            <div class="stat-card">
                <div class="stat-value">Rp {{ number_format($countAllPrice ?? 0, 0, ',', '.') }}</div>
                <div class="stat-label">Total Revenue</div>
            </div>
            <div class="stat-card">
                <div class="stat-value">Rp {{ number_format($countCash ?? 0, 0, ',', '.') }}</div>
                <div class="stat-label">Cash Revenue</div>
            </div>
            <div class="stat-card">
                <div class="stat-value">Rp {{ number_format($countQris ?? 0, 0, ',', '.') }}</div>
        ...
        <div class="charts-row">
            ...
            <div class="chart-container-pie">
                <div class="chart-title">Payment Methods - {{ $latestMonthName ?? 'Current Month' }}</div>
    ...
    const comparisonChart = new Chart(comparisonCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: @json($last12MonthsQrisData ?? []),
                borderColor: '#3498db',
                backgroundColor: 'rgba(52, 152, 219, 0.1)',
                borderWidth: 3,
                fill: false,
                ...
                data: @json($last12MonthsCashData ?? []),
                borderColor: '#2ecc71',
