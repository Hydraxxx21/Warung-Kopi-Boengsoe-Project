...
class ProductController extends Controller
{
    ...
    public function checkout()
    {
        ...
        $products = array_filter($order, function ($key) {
    ...
    public function confirm()
    {
        ...
        if (empty($order) || empty($guest)) {
            return redirect()->route('dashboard.index')->with('error', 'Data pesanan tidak ditemukan');
        }
