...
class PemesananController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $totalFromCash = Orders::where('status', 'completed')->where('payment_method', 'cash')->sum('total_price');
        $totalFromQris = Orders::where('status', 'completed')->where('payment_method', 'qris')->sum('total_price');
    ...
    public function updatePaymentMethod(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('pemesanan.index')->with('success', 'Metode pembayaran berhasil diperbarui.');
        } catch (\Throwable $th) {
            //throw $th;
            return redirect()->back()->with('error', 'Gagal memperbarui metode pembayaran. ' . $th->getMessage());
        }
    }
    ...
    public function updateTableNumber(Request $request)
    {
        $user = Auth::user();
        ...
        try {
            ...
            return redirect()->back()->with('error', 'Gagal memperbarui pesanan. ' . $th->getMessage());
        }
    }
}
